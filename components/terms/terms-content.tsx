        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                {t(
                  '欢迎使用FileMarkd（"我们"、"我们的"或"本服务"）。FileMarkd是一个开源的SaaS（软件即服务）模板，提供网站托管、用户认证、订阅与支付、推广返利、后台管理等功能。您可以将其作为产品部署，也可以基于源码进行二次开发。',
                  '歡迎使用FileMarkd（"我們"、"我們的"或"本服務"）。FileMarkd是一個開源的SaaS（軟件即服務）模板，提供網站託管、用戶認證、訂閱與支付、推廣返利、後台管理等功能。您可以將其作為產品部署，也可以基於源碼進行二次開發。',
                  'FileMarkd（以下「当社」「当社の」または「本サービス」）へようこそ。FileMarkdはオープンソースのSaaS（Software as a Service）テンプレートであり、ウェブサイトホスティング、ユーザー認証、サブスクリプションと決済、アフィリエイト、管理画面などの機能を提供します。製品としてデプロイすることも、ソースコードをベースに二次開発することも可能です。',
                  'FileMarkd("당사", "당사의" 또는 "본 서비스")를 사용해 주셔서 환영합니다. FileMarkd는 오픈소스 SaaS(Software as a Service) 템플릿으로, 웹사이트 호스팅, 사용자 인증, 구독 및 결제, 제휴 추천, 관리자 콘솔 등의 기능을 제공합니다. 제품으로 배포하거나 소스코드를 기반으로 2차 개발할 수 있습니다.',
                  'Welcome to FileMarkd ("we", "our", or "the service"). FileMarkd is an open-source SaaS (Software as a Service) template that provides website hosting, user authentication, subscriptions and payments, referral and affiliate programs, and an admin dashboard. You may deploy it as a product or fork the source code for further development.'
                )}
              </p>
              <p className="mb-4">
                {t(
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                {t('FileMarkd的源代码、商标、Logo、网站设计、品牌及相关内容受知识产权法保护。源代码遵循MIT开源协议，您可以在协议范围内自由使用、修改和分发。', 'FileMarkd的源代碼、商標、Logo、網站設計、品牌及相關內容受知識產權法保護。源代碼遵循MIT開源協議，您可以在協議範圍內自由使用、修改和分發。', 'FileMarkdのソースコード、商標、ロゴ、ウェブサイトデザイン、ブランドおよび関連コンテンツは知的財産法により保護されます。ソースコードはMITオープンソースライセンスの下で提供され、ライセンスの範囲内で自由に使用、修正、配布できます。', 'FileMarkd의 소스코드, 상표, 로고, 웹사이트 디자인, 브랜드 및 관련 콘텐츠는 지적 재산권법에 의해 보호됩니다. 소스코드는 MIT 오픈소스 라이선스를 따르며, 라이선스 범위 내에서 자유롭게 사용, 수정 및 배포할 수 있습니다.', 'The source code, trademarks, logo, website design, branding, and related content of FileMarkd are protected by intellectual property laws. The source code is released under the MIT License; you may freely use, modify, and redistribute it within the scope of that license.')}
              </p>
              <p className="mb-4">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside mb-4 space-y-2">
                ...
                <li>{t('网站：https://filemarkd.com', '網站：https://filemarkd.com', 'ウェブサイト：https://filemarkd.com', '웹사이트: https://filemarkd.com', 'Website: https://filemarkd.com')}</li>
              </ul>
            </section>
          </div>
        </div>
