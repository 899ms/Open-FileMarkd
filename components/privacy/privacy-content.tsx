        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                {t(
                  'FileMarkd（"我们"、"我们的"或"本服务"）非常重视用户隐私。本隐私政策说明我们在您访问和使用我们的网站时，如何收集、使用、存储和保护您的个人信息。',
                  'FileMarkd（"我們"、"我們的"或"本服務"）非常重視用戶隱私。本隱私政策說明我們在您訪問和使用我們的網站時，如何收集、使用、存儲和保護您的個人信息。',
                  'FileMarkd（以下「当社」「当社の」または「本サービス」）は、ユーザーのプライバシーを非常に重視しています。本プライバシーポリシーでは、お客様が当社のウェブサイトにアクセスし利用する際に、当社がどのように個人情報を収集、使用、保存、保護するかを説明します。',
                  'FileMarkd("당사", "당사의" 또는 "본 서비스")는 사용자 개인정보를 매우 중요하게 생각합니다. 본 개인정보 처리방침은 귀하가 당사 웹사이트에 접속하여 이용하실 때 당사가 개인정보를 어떻게 수집, 사용, 저장 및 보호하는지를 설명합니다.',
                  'FileMarkd ("we", "our", or "the service") takes user privacy seriously. This Privacy Policy explains how we collect, use, store, and protect your personal information when you access and use our website.'
                )}
              </p>
              <p className="mb-4">
                {t(
