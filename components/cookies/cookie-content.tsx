        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                {t(
                  'FileMarkd 同时使用 Cookie 与类似技术（如 localStorage、sessionStorage）来保证核心功能正常运行、统计站点使用情况，并支持推广返利追踪。',
                  'FileMarkd 同時使用 Cookie 與類似技術（如 localStorage、sessionStorage）來保證核心功能正常運行、統計站點使用情況，並支援推廣返利追蹤。',
                  'FileMarkd は、Cookie および類似技術（localStorage、sessionStorage など）を使用して、コア機能の安定動作、サイトの利用統計、推薦・アフィリエイトの追跡を実現しています。',
                  'FileMarkd는 쿠키와 유사 기술(localStorage, sessionStorage 등)을 함께 사용하여 핵심 기능의 안정적 작동, 사이트 이용 통계, 추천 및 제휴 추적을 지원합니다.',
                  'FileMarkd uses cookies and similar technologies (such as localStorage and sessionStorage) to keep core features working, gather site usage statistics, and support referral and affiliate tracking.'
                )}
              </p>
            </section>
