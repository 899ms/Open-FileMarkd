...
export const POINTS_PRICE_IDS = {
  starter: getPriceId(process.env.STRIPE_POINTS_STARTER_PRICE_ID, ''), // 500积分 - $5
  popular: getPriceId(process.env.STRIPE_POINTS_POPULAR_PRICE_ID, ''), // 1,500积分 - $15
  premium: getPriceId(process.env.STRIPE_POINTS_PREMIUM_PRICE_ID, ''), // 12,000积分 - $100
} as const
...
export const SUBSCRIPTION_PRODUCTS = {
  ...
  annual: {
    ...
    price: 99,
    originalPrice: 179.88, // $14.99 * 12 = $179.88
    interval: 'year',
    intervalCount: 1,
    giftedPoints: 12000, // 订阅赠送的积分
    features: [
      'Full access to all agents',
